...
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['additionalJs']['0']      = 'Πρόσθετα αρχεία javascript';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['additionalJs']['1']      = 'Επιλέξτε αυτό, εάν θέλετε να συμπεριλάβετε πρόσθετα αρχεία javascript.';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['copy']['0']              = 'Αντιγράφη ορισμού ρύθμισης ';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['copy']['1']              = 'Αντιγραφή ρύθμισης ID%s ';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['delete']['0']            = 'Διαγραφή ρύθμισης ';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['delete']['1']            = 'Διαγραφή ρύθμισης ID %s';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['edit']['0']              = 'Επεξεργασια ρυθμισης';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['edit']['1']              = 'Επεξεργασια του ID %s ';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['expert_legend']          = 'Ειδικες ρυθμισεις';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['file']                   = 'Αρχειο';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['format']['0']            = 'Μορφή εξόδου: ';
...
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['jumpTo_page']['1']       = 'Η σελίδα που θα χρησιμοποιηθεί για συνδέσεις λεπτομέρειων. ';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['name']['0']              = 'Ονομα';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['name']['1']              = 'Ονομα ρυθμισης.';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['new']['0']               = 'Νεος τυπος';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['new']['1']               = 'Δημιουργια νεας ρυθμισης';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['publish']                = ' Δημοσιεύση ';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['settings']['0']          = 'Ορίσμος τις ρυθμίσεις χαρακτηριστικόυ ';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['settings']['1']          = 'Ορίσμος τις ρυθμίσεις χαρακτηριστικόυ για τη ρύθμιση ID %s';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['show']['0']              = 'Λεπτομερειες ρυθμισης ';
$GLOBALS['TL_LANG']['tl_metamodel_rendersettings']['show']['1']              = 'Δείτε λεπτομέρειες σχετικά με τη ρύθμιση ID%s';
