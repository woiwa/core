...
$GLOBALS['TL_LANG']['tl_metamodel_dca']['becap_description']['1']   = 'Dieser Text wird als Beschreibung (Hover) im Backend benutzt.';
$GLOBALS['TL_LANG']['tl_metamodel_dca']['becap_label']['0']         = 'Labeltext';
